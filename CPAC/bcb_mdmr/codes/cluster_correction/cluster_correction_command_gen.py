...
for smoothness in ['8']:
    for variable in variable_list:
        for group in group_list:
            command = f"python cluster_extraction_nilearn_arbitary.py --smoothness {smoothness} --regressor_file {group}_{variable}_regressor_non_scaled.csv --vox_threshold 0.005 &&"
            print(command)